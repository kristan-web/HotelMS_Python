...
class StaffLoginView(QWidget):
    """
    Split-panel Staff Login screen.
    Left = pink branding | Right = dark purple login form
    Navigation signals (wire in controller):
        self.login_btn       → authenticate staff
        self.admin_btn       → open AdminLoginView
        self.forgot_lbl      → open ForgotPasswordView
    """
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Staff Login — Hotel MS")
    ...
    def _build_left_panel(self):
        ...
        sub = QLabel("Staff Access Portal")
    ...
    def _build_right_panel(self):
        ...
        self.admin_btn.setFont(QFont("Segoe UI Semilight", 12, QFont.Weight.Bold))
        self.admin_btn.setFixedSize(86, 42)
        ...
        layout.addWidget(self.admin_btn, alignment=Qt.AlignmentFlag.AlignRight)
    ...
    def login(self):
        ...
        # Here you would call your controller to authenticate
        self.show_message("Success", "Login successful! (Demo)")
        
        # Navigate to dashboard after login
        # from views.Dashboard.StaffDashBoardView import StaffDashBoardView
        # self.dashboard = StaffDashBoardView()
        # self.dashboard.show()
        # self.close()
    ...
    def open_admin_login(self):
        ...
        self.admin_login = AdminLoginView()
    ...
    def open_forgot_password(self, event):
        ...
        self.forgot_view = ForgotPasswordView()
