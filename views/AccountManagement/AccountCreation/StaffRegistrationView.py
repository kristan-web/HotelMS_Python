...
class StaffRegistrationView(QWidget):
    ...
    def _build_form_panel(self):
        ...
        self.register_btn.clicked.connect(self.register_staff)
    ...
    def go_back(self):
        """Navigate back to Staff and Admin Account View"""
    ...
    def register_staff(self):
        ...
        self.show_message("Success", "Staff account registered successfully!")
        from views.AccountManagement.AccountAdministration.StaffAndAdminAccountView import StaffAndAdminAccountView
        self.account_view = StaffAndAdminAccountView(self.main_window)
        self.account_view.show()
        self.close()
