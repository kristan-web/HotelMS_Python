...
class AdminRegistrationView(QWidget):
    """
    Admin Registration View.
    Split-panel form for registering new admin accounts.
    """
    ...
    def __init__(self, main_window=None, source="dashboard"):
        ...
        self.source = source
        self.setWindowTitle("Admin Registration — Hotel MS")
    ...
    def _build_form_panel(self):
        ...
        # Title
        title = QLabel("Admin Registration")
    ...
    def _build_branding_panel(self):
        ...
        sub = QLabel("Registration Form for Admin.")
    ...
    def register_admin(self):
        ...
        # Success - emit signal to go back
        self.show_message("Success", "Admin account registered successfully!")
        self.back_requested.emit()
        self.close()
