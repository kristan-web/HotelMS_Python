...
class AddGuestView(QDialog):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("Add New Guest")
        self.setModal(True)
    ...
    def _build_ui(self):
        ...
        address_lbl.setFont(QFont("Segoe UI Semilight", 11))
