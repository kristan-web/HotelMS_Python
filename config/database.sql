...
-- Check if column exists before adding (run these separately)
...
-- For reservation_services table
ALTER TABLE reservation_services ADD COLUMN is_deleted TINYINT(1) NOT NULL DEFAULT 0;

-- For receipts table
ALTER TABLE receipts ADD COLUMN is_deleted TINYINT(1) NOT NULL DEFAULT 0;